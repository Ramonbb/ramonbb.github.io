...
const translations = {
  en: {
    ...
    publications: {
      ...
      dataset: "Dataset",
      citation: "Citation",
      abstractOne: "This study applies LDA topic modeling and sentiment analysis to online cruise reviews to identify service attributes, satisfaction drivers, and experience dimensions.",
      abstractTwo: "This empirical study examines service quality perceptions in online tourism platforms using quantitative modeling and customer feedback data.",
      abstractThree: "This study analyzes resident attitudes toward tourism impacts, destination development, and sustainable management strategies through a segmentation approach.",
      abstractFour: "This study shows how online reviews reveal perceptions of authenticity, service delivery, and heritage value in historic accommodation settings."
    },
    projects: {
  ...
  es: {
    ...
    publicationTags: {
      ...
      sentimentAnalysis: "Análisis de Sentimientos",
      tourismMarketing: "Marketing Turístico",
      lda: "Modelado de Temas LDA",
      consumerBehavior: "Comportamiento del Consumidor"
    },
    home: {
    ...
    publications: {
      ...
      metrics: "Métricas de la publicación",
      citations: "Citas",
      downloads: "Descargas",
      abstract: "Resumen",
      ...
      dataset: "Datos",
      citation: "Cita",
      abstractOne: "Este estudio aplica modelado de temas LDA y análisis de sentimientos a reseñas de cruceros en línea para identificar atributos del servicio, factores de satisfacción y dimensiones de la experiencia.",
      abstractTwo: "Este estudio empírico analiza las percepciones de calidad del servicio en plataformas turísticas en línea mediante modelización cuantitativa y datos de opinión de clientes.",
      abstractThree: "Este estudio analiza las actitudes de los residentes ante los impactos del turismo, el desarrollo del destino y las estrategias de gestión sostenible mediante un enfoque de segmentación.",
      abstractFour: "Este estudio muestra cómo las reseñas en línea revelan percepciones de autenticidad, prestación del servicio y valor patrimonial en alojamientos históricos."
    },
    projects: {
...
function applyLanguage(language) {
  ...
  document.querySelectorAll(".abstract-toggle").forEach((button) => {
    ...
    button.setAttribute("aria-expanded", String(Boolean(abstract && !abstract.hasAttribute("hidden"))));
  });
