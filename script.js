...
function createPublicationActions(publication, abstractId) {
  ...
  if (articleUrl) {
    ...
    link.append(icon, createElement("span", "", getTranslation(currentLanguage, "publications.viewArticle")));
    actions.append(link);
  }
  ...
  const citeIcon = createElement("span", "", "§");
  citeIcon.setAttribute("aria-hidden", "true");
  citeButton.append(citeIcon, createElement("span", "", getTranslation(currentLanguage, "publications.cite")));
  ...
  if (resultsUrl) {
    ...
    const icon = createElement("span", "", "▦");
    icon.setAttribute("aria-hidden", "true");
    link.append(icon, createElement("span", "", getTranslation(currentLanguage, "publications.exploreResults")));
    actions.append(link);
  }
